...
![대체 z값을 어떤 기준으로 정렬??](attachment/60839c2a17c1044f3ad249bd35698046.png)
...
(OpenGL은 Fragment processor 다음에 처리)](attachment/544d2812fbeb6ca292c55a7caa0d3ba5.png)
...
![Clipping Window 밖인지 체크 / N.S. 밖인지 체크 / Viewport 밖인지 체크](attachment/4344af7fb048f2f68efe564f2fd27b8a.png)
...
![$x_{min}$직선으로 영역 나누고, $x_{max}$직선으로 영역 나누고, $y_{min}$직선으로 영역 나누고, $y_{max}$로 마무리](attachment/7b6fcd121c05393a73bbb50c664ac366.png)

##### 구체적으론

![TOP 직선($y_{max}$)을 기준으로 교점을 구해내고 커트.](attachment/750ebcb800b3fa06a910255e7f4ab302.png)

![순서대로 한번씩 기준되어 교점들 구해지며 커트.](attachment/a0de57c33ed5ec146b138f6f6d0c74ed.png)
...
![CCW순으로 그려서, 아래벡터$\times$위벡터 = 법선벡터 위방향 (오른나사로 보면 될듯)](attachment/b1dec08227a99f0a72aa13b3e18b16a8.png)
...
![Stencil buffer + image $\rightarrow$ test $\rightarrow$ result](attachment/4cc96bbeb0065243473acc467335fc38.png)
